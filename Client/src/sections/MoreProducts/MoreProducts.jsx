...
const MoreProducts = () => {
  ...
  const handleNext = () => {
    const row = document.querySelector('.productPage-products-row');
    const cards = document.querySelectorAll('.productPage-product-card');
  ...
  return (
    <div className="productPage-products-section">
      ...
      <div
        className="productPage-slider-container"
      ...
      >
        ...
        <div className="productPage-products-row">
        ...
        {/* <button className="homePage-slider-arrow right" onClick={handleNext} disabled={currentIndex >= featuredProducts.length - cardsToShow}>
         ...
         <button className="productPage-prevProd" onClick={handlePrev} disabled={currentIndex === 0}>&#10094;</button>
          <button className="productPage-nextProd" onClick={handleNext} disabled={currentIndex >= featuredProducts.length - cardsToShow}>&#10095;</button>
      </div>
    </div>
  );
};
