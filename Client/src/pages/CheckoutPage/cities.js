const cities = {
  ...
  'Istanbul': [
    ...
    'Esenyurt', 'Eyüp', 'Fatih', 'Gaziosmanpaşa', 
  ...
  'Kütahya': [
    ...
    'Merkez', 'Pazarlar', 'Şaphane', 'Simav', 
    'Tavşanlı'
  ],
  'Malatya': [
    'Akçadağ', 'Arapgir', 'Arguvan', 'Battalgazi', 
    'Darende', 'Doğanşehir', 'Doğanyol', 'Hekimhan', 
    'Kale', 'Kuluncak', 'Pütürge', 'Yazıhan', 
    'Yeşilyurt'
  ],
  'Manisa': [
    'Ahmetli', 'Akhisar', 'Alaşehir', 'Demirci', 
    'Gölmarmara', 'Gördes', 'Kırkağaç', 'Kula', 
    'Köprübaşı', 'Salihli', 'Sarıgöl', 'Saruhanlı', 
    'Selendi', 'Soma', 'Şehzadeler', 'Turgutlu', 
    'Yunusemre'
  ],
  'Mardin': [
  ...
  'Ordu': [
    ...
    'Gürgentepe', 'Gülyalı', 'İkizce', 'Kabadüz', 
  ...
  'Samsun': [
    'Alaçam', 'Asarcık', 'Atakum', 'Ayvacık', 
    'Bafra', 'Canik', 'Çarşamba', 'Havza', 
    'İlkadım', 'Kavak', 'Ladik', 'Salıpazarı', 
  ...
  'Zonguldak': [
    ...
    'Karadeniz Ereğli', 'Kilimli', 'Kozlu', 'Merkez'
  ]
